...
public class student {
       public void insertUpdateDeleteStudent(char operation, Integer id, String fname, String lname, String sex,
           ...
           if (operation == 'd') { // d for delete
               int yesOrNo = JOptionPane.showConfirmDialog(null, "This Score Will Be Also Deleted", "Delete Student", JOptionPane.OK_CANCEL_OPTION, 0);
       ...
       public void fillStudentJtable(JTable table, String valueToSearch) {
           ...
           PreparedStatement ps;
           try {
               ps = con.prepareCall("SELECT * FROM `student` WHERE CONCAT(`first_name`, `last_name`, `phone`, `address`) LIKE ?");
